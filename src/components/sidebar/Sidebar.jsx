...
function Sidebar() {
  ...
  let content = (
    <>
      <div className="flex justify-start m-4 rounded-full bg-slate-700 p-2 md:hidden lg:hidden">
        <RxHamburgerMenu
          className="w-8 h-8 text-white"
          onClick={toggleSidebar}
        />
      </div>
      <div className="hidden md:flex lg:flex flex-col w-screen md:w-64 lg:w-64 h-screen px-4 py-8 bg-slate-900 border-slate-700 border-r-4">
